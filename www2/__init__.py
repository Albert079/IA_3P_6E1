...
def webhook_whatsapp():
    ...
    if mensaje is not None:
      ...
      mydb = mysql.connector.connect(
          host = "mysql-albert79.alwaysdata.net",
          user = "albert79",
          password = "admin9190",
          database='albert79_chat'
      )
...
def enviar(telefonoRecibe,respuesta):
  ...
  token='EAADJZBPVER5cBAIfGrIj3H4XVEdi0w1xZBfTSCDeYWUp0dkbtZBAAQi1Lp3ieXZCdJaraZAm4DSmTNbFVjh785ZCZARZAxCpWANVL5Bzn4ZAzo8iNAJCF3ZAFgkSWRTot9F95k1oAKYx4pmYLZCx2QIH34FGVAf8vm0zG9dxmCanNRqrTO1OtZBuHUQZBrhdZAN23l8xWlEROZBYSZBtShl8fPbytj3l'
  #IDENTIFICADOR DE NÚMERO DE TELÉFONO
  idNumeroTeléfono='108701318926110'
